...
<head>
    ...
    <title>Filiales de <?php $agence; ?></title>
</head>
<body">
    ...
    <table>
        ...
        <?php 
            $num_rows = count($datas->getFiliale_from_agency($id));
            if($num_rows == 0) {
                echo '<tr class="container-elements">';
                echo '<td><a href="#">Aucun resultat</a></td>';
                echo '<td><a href="#">Aucun resultat</a></td>';
                echo '<td><a href="#">Aucun resultat</a></td>';
                echo '</tr>';
            }
                ...
                $filiales = $datas->getFiliale_from_agency($id);

...
<head>
    ...
    <link rel="stylesheet" href="../../css/dark css/superadmin css/list.css">
    ...
    <table>
        ...
        <?php foreach($users as $user): ?>
            <tr class="container-elements">
                ...
                <td class="td-visible"><a href="update.php?iduser=<?= $user["iduser"] ?>" class="fa fa-pencil-square-o"></a></td>

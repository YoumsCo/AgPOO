<?php 
    ...
    $datas = new admin();
    $towns = $datas->crud("select", "ville", "intitule", "select * from ville order by intitule", null, null, null, null);
?>
...
<body>
    ...
    <table>
        <tr>
            <th class="th-visible">idville</th>
        ...
        <?php foreach($towns as $town): ?>
            <tr class="container-elements">
                <td class="td-visible"><?= $town["idville"] ?></td>
                <td class="td-visible"><?= $town["intitule"] ?></td>
                <td class="td-visible"><?= $town["montant"] ?></td>
                <td class="td-visible"><a href="update.php?idville=<?= $town["idville"] ?>" class="fa fa-pencil-square-o"></a></td>
                <td class="td-visible"><a href="delete.php?idville=<?= $town["idville"] ?>" class="fa fa-trash-o"></a></td>
            </tr>
        <?php endforeach; ?>
    </table>

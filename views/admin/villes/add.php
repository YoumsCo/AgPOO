    ...
    <div id="container">
        <div class="container-form form-sign-up">
            <form action="<?php echo htmlspecialchars('../../../controllers/adminController.php'); ?>" method="POST">
                ...
                <div>
                    <input type="text" name="montant" placeholder="Entrez le montant" title="Montant" pattern="\d{4,6}" required>
                    <label class="label">Montant</label>
                </div>
                <div>
                    <input type="submit" name="insert_ville" value="Modifier" title="Modifier">
                </div>
            </form>
        </div>

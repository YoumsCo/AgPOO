    ...
    <div id="container">
        <div class="container-form form-sign-up">
            <form action="<?= htmlspecialchars('../../../controllers/adminController.php'); ?>" method="POST">
                ...
                <div>
                    <input type="text" name="image" placeholder="Entrez le lien de l'image" minlength="10" title="Image" required>
                    <label class="label">Image</label>
                </div>
                <div>
                    <input type="submit" name="insert" value="Ajouter" title="Ajouter">
                </div>
            </form>
        </div>

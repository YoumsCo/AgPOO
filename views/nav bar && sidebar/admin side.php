...
<link rel="stylesheet" href="../../../css/dark css/admin css/admin side .css">
...
<div id="side-bar">
    <div id="picture">
        <img src="<?= $_SESSION['img'] ?>" class="img" alt="photo">
        <div id="picture-icons">
            <label class="fa fa-camera"></label>
            <a href="../../user/deconnexion.php" class="fa fa-sign-out"></a>
        </div>
    ...
    <ul id="container-itens">
        ...
        <a href="../../admin/agences/agencies_list.php" class="items <?= current_page('agencies_list') ?>">
            <i class="fa fa-bus"></i>
            &nbsp;
            Agences
        </a>
        <a href="../../admin/filiales/filiales_list.php" class="items <?= current_page('filiales_list') ?>">
            <i class="fa fa-bus"></i>
            &nbsp;
            Filiales
        </a>
        <a href="../../admin/modes/modes_list.php" class="items <?= current_page('mode') ?>">
            <i class="fa fa-user-secret"></i>
            &nbsp;
            Modes
        </a>
        <a href="../../admin/reservations/reservations_list.php" class="items <?= current_page('reservations') ?>">
            <i class="fa fa-angle-double-up"></i>
            &nbsp;
            Reservations
        </a>
        <a href="../../admin/typebus/bustype_list.php" class="items <?= current_page('bustype') ?>">
            <i class="fa fa-angle-double-up"></i>
            &nbsp;
            Type de bus
        </a>
        <a href="../../admin/villes/towns_list.php" class="items <?= current_page('towns') ?>">
            <i class="fa fa-angle-double-up"></i>
            &nbsp;
            Villes
        </a>
...
<script src="../../../js/admin side.js"></script>
